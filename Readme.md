...
* Студент: [Карина Маулитова](https://up.htmlacademy.ru/htmlcss/23/user/880787).
* Наставник: `Ирина Шашева`.

[Ссылка на готовый сайт](https://karinamaulitova.github.io/880787-gllacy/
) 

Данный проект выполнен на HTML, CSS и JS. В проекте используется flexbox для построения сетки, а так же сделана карусель на чистом CSS. Для открытия модальных окон использован JS
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/880787-gllacy) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
